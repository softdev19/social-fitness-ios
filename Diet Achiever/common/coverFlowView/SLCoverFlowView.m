...
- (void)scrollViewWillEndDragging:(UIScrollView *)scrollView
    ...
    if (_endDraggingVelocity.x == 0) {
        ...
        *targetContentOffset = [self nearByOffsetOfScrollViewContentOffset:_scrollView.contentOffset];
        ...
        //custom by wang
        NSInteger index = [self nearByIndexOfScrollViewContentOffset:[self nearByOffsetOfScrollViewContentOffset:_scrollView.contentOffset]];
...
//        if(distance > self.coverSize.width / 2.0)
//            distance = self.coverSize.width / 2.0 - 50.0;
        ...
        //custom by wang
        index = [self nearByIndexOfScrollViewContentOffset:nearByOffset];
        [self.delegate indexOfScroll:index];
        //
